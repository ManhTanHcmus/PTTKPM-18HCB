...
namespace ManageRoles
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
			...
			container.RegisterType<IMonThi, MonThiConcrete>();
			container.RegisterType<IDeThi, DeThiConcrete>();
			container.RegisterType<ICauHoi, CauHoiConcrete>();
			container.RegisterType<IToChucThi, ToChucThiConcrete>();
